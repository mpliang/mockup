...
describe('htSidebar directive: ', function () {
    ...
    beforeEach(inject(function ($compile, $rootScope) {
        ...
        el = angular.element('<ht-sidebar when-done-animating="vm.sidebarReady(42)">' + '<div class="sidebar-dropdown"><a href="">Menu</a></div>' + '<div class="sidebar-inner" style="display: none"></div>' + '</ht-sidebar>');
    ...
    function hasIsOpenClass(isTrue) {
        ...
        expect(hasClass).equal(!!isTrue, 'dropdown has the "is open" class is ' + hasClass);
    }
    ...
    function dropdownIsVisible(isTrue) {
        ...
        expect(display).to.equal(isTrue ? 'block' : 'none', 'innerElement display value is ' + display);
    }
});